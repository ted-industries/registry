...
## how it works
it proxies requests from `registry.ted.tomlin7.com` (available via `/`, `/v1`, or `/v1/extensions.json`) to the actual source index at `extensions.ted.tomlin7.com/v1/extensions.json`.
